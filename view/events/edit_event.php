            ...
            <form action="." method="post" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="eventCategory" name="category_id" class="form-control">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" id="eventDate" name="event_date" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="eventDate">Image Link:</label>
